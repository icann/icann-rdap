...
Searches are not enabled by default. Each one must be explicitly enabled with an environment variable:
    ...
    RDAP_SRV_IP_RDAP_UP
    RDAP_SRV_IP_RDAP_TOP
    RDAP_SRV_IP_RDAP_DOWN
    RDAP_SRV_IP_RDAP_BOTTOM
    RDAP_SRV_AUTNUM_RDAP_UP
    RDAP_SRV_AUTNUM_RDAP_TOP
    RDAP_SRV_AUTNUM_RDAP_DOWN
    RDAP_SRV_AUTNUM_RDAP_BOTTOM
    RDAP_SRV_DOMAIN_RDAP_UP
    RDAP_SRV_DOMAIN_RDAP_TOP
    RDAP_SRV_DOMAIN_RDAP_DOWN
    RDAP_SRV_DOMAIN_RDAP_BOTTOM
    RDAP_SRV_NETWORK_SEARCH_BY_HANDLE
    RDAP_SRV_NETWORK_SEARCH_BY_NAME
    RDAP_SRV_AUTNUM_SEARCH_BY_HANDLE
    RDAP_SRV_AUTNUM_SEARCH_BY_NAME
