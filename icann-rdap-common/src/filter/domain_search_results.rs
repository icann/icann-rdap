                ...
                Filter::AbuseEmail => FilterOutput {
                    ...
                    value: FilterValue::StringArray(
                        self.results()
                            .iter()
                            .filter_map(|r| {
                                find_entity_email_by_role(r.entities(), EntityRole::Abuse)
                            })
                            .collect(),
                    ),
                },
                ...
                Filter::TechnicalEmail => FilterOutput {
                    ...
                    value: FilterValue::StringArray(
                        self.results()
                            .iter()
                            .filter_map(|r| {
                                find_entity_email_by_role(r.entities(), EntityRole::Technical)
                            })
                            .collect(),
                    ),
                },
                ...
                Filter::RegistrarEmail => FilterOutput {
                    ...
                    value: FilterValue::StringArray(
                        self.results()
                            .iter()
                            .filter_map(|r| {
                                find_entity_email_by_role(r.entities(), EntityRole::Registrar)
                            })
                            .collect(),
                    ),
                },
