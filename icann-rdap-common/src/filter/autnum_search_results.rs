                ...
                Filter::AbuseEmail => FilterOutput {
                    ...
                    value: FilterValue::StringArray(
                        self.results()
                            .iter()
                            .filter_map(|a| {
                                find_entity_email_by_role(a.entities(), EntityRole::Abuse)
                            })
                            .collect(),
                    ),
                },
                ...
                Filter::TechnicalEmail => FilterOutput {
                    ...
                    value: FilterValue::StringArray(
                        self.results()
                            .iter()
                            .filter_map(|a| {
                                find_entity_email_by_role(a.entities(), EntityRole::Technical)
                            })
                            .collect(),
                    ),
                },
                ...
                Filter::RegistrarEmail => FilterOutput {
                    ...
                    value: FilterValue::StringArray(
                        self.results()
                            .iter()
                            .filter_map(|a| {
                                find_entity_email_by_role(a.entities(), EntityRole::Registrar)
                            })
                            .collect(),
                    ),
                },
