...
#[derive(PartialEq, Eq, Debug, EnumString, EnumDisplay, EnumIter)]
...
mod tests {
    ...
    #[test]
    fn iana_event_action_values_match_enum() {
        ...
        for variant in EventActionValue::iter() {
        ...
        if !missing.is_empty() || !extra.is_empty() {
            let mut msg = String::from("EventActionValue enum does not match IANA registry:\n");
            if !missing.is_empty() {
